#!/bin/bash
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash eval/relpose/run_tum.sh pi3_5T_48f_ft_cam1_local1_global0_chunkloss_roe_gradclip1_xcloud_win12-4_overlap3-1_tttv8_l1_35_multi4_h280_pe3/run_20251102_0934 --num-processes 4 --window-size 48 --overlap-size 3
...
usage() {
    cat <<'EOF'
Usage: eval/relpose/run_tum.sh <checkpoint_run_path> [options] [datasets...]
...
Optional flags:
  --datasets list        Comma-separated dataset names (default: tum_s1_1000)
  ...
  --output-root PATH     Base directory for evaluation outputs (default: ${REPO_ROOT}/eval_results/relpose)
